...
public class TotemOfSoulProtectionItem extends ArtifactDefensiveItem{
    public TotemOfSoulProtectionItem() {
        super(
                McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getDurability()
        );
    }

    public ActionResult useOnBlock (ItemUsageContext itemUsageContext){
        float cloudRadius = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getInnerStat().mcdar$getCloudRadius();
        int cloudDuration = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getInnerStat().mcdar$getCloudDuration();
        int effectDuration = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getInnerStat().mcdar$getEffectDuration();
        int amplifier = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getInnerStat().mcdar$getAmplifier();
        int maxCooldownEnchantmentTime = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getMaxCooldownEnchantmentTime();
            ...
            if (itemUsageContextPlayer != null){
                ...
                AOECloudHelper.spawnStatusEffectCloud(
                        ...
                        new StatusEffectInstance(
                                RegistryEntry.of(StatusEffectRegistry.SOUL_PROTECTION),
                                effectDuration,
                                amplifier
                        )
                );
