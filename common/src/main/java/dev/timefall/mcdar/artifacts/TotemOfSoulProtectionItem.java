...
public class TotemOfSoulProtectionItem extends ArtifactDefensiveItem {
    public TotemOfSoulProtectionItem() {
        super(McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS);
    }

    public ActionResult useOnBlock (ItemUsageContext itemUsageContext) {
        float cloudRadius = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getCloudRadius();
        int cloudDuration = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getCloudDuration();
        int effectDuration = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getEffectDuration();
        int amplifier = McdarArtifactsStatsConfig.CONFIG.mcdar$getDefensiveArtifactStats().TOTEM_OF_SOUL_PROTECTION_STATS.mcdar$getAmplifier();
            ...
            if (itemUsageContextPlayer != null){
                ...
                AOECloudHelper.spawnStatusEffectCloud(
                        ...
                        new StatusEffectInstance(
                                StatusEffectRegistry.SOUL_PROTECTION.getEntry(),
                                effectDuration,
                                amplifier
                        )
                );
