...
import dev.timefall.mcdar.entities.WonderfulWheatLlamaEntity;
...
public class WonderfulWheatLlamaDecorFeatureRenderer extends FeatureRenderer<WonderfulWheatLlamaEntity, LlamaEntityModel<WonderfulWheatLlamaEntity>> {
    private static final Identifier TRADER_LLAMA_DECOR = Identifier.of("textures/entity/llama/decor/trader_llama.png");
