package dev.timefall.mcdar.entity;

import dev.timefall.mcdar.api.SummoningHelper;
import dev.timefall.mcdar.api.interfaces.Summonable;
import dev.timefall.mcdar.goal.FollowSummonerGoal;
import dev.timefall.mcdar.goal.TrackSummonerAttackerGoal;
...
public class EnchantedGrassBlueSheepEntity extends SheepEntity implements Tameable, Summonable {
    ...
    public static DefaultAttributeContainer.Builder createEnchantedBlueSheepAttributes(){
