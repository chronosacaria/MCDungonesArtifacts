...
public enum StatusInflictingArtifactID implements IArtifactItem {
    ...
    public Boolean mcdar$isEnabled() {
        return McdarArtifactsStatsConfig.CONFIG.STATUS_INFLICTING_ARTIFACT_STATS.get(this).mcdar$getIsEnabled();
    }
    ...
    public Set<String> mcdar$getGeneralLootTables() {
        return McdarArtifactsStatsConfig.CONFIG.STATUS_INFLICTING_ARTIFACT_STATS.get(this).mcdar$getGeneralLootTables();
    }

    @Override
    public Set<String> mcdar$getDungeonLootTables() {
        return McdarArtifactsStatsConfig.CONFIG.STATUS_INFLICTING_ARTIFACT_STATS.get(this).mcdar$getDungeonLootTables();
    }
    @Override
        ...
        if (this.mcdar$getGeneralLootTables().contains(id.toString())) {
            lootPoolBuilder
                    .with(ItemEntry.builder(this.mcdar$getItem())
                            .weight(McdarArtifactsStatsConfig.CONFIG.STATUS_INFLICTING_ARTIFACT_STATS
